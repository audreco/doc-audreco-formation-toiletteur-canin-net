...
@section('body')
<section style="background-image: url(/assets/img/tmp-img/shutterstock_280679357.jpg); background-size: cover; background-position: 50% 30%; height: 60vh;">
...
<section class="container max-w-6xl mx-auto px-6 py-10 md:py-12">
    ...
    <!-- <div class="md:flex -mx-2 -mx-4"> -->
        ...
        <!-- <div class="mb-8 mx-3 px-2 md:w-1/3"> -->
            ...
            <p>
                <a href="https://audreco.com/mon-chien/?utm_source=formation+toiletteur+canin+net">Tout ce que vous avez toujours cru savoir sur votre chien ou votre chat,<br>et qui n'est peut-être pas vrai !</a> <br>
                <a href="http://entreprendre-animaux.audreco.com/?utm_source=formation+toiletteur+canin+net">Entreprendre dans les métiers de services auprès des animaux !</a>
            </p>
        </div>
        ...
        <!-- <div class="mx-3 px-2 md:w-1/3"> -->
            ...
            <p>Des livres pour tous ! <a href="https://librairie.audreco.com?utm_source=formation+toiletteur+canin+net">Accéder à la librairie</a>
            </p>
        </div>
    </div>
</section>
